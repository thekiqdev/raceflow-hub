...
import { Search, Eye, Calendar, Mail, Phone, MessageSquare, Loader2 } from "lucide-react";
...
const ContactMessagesManagement = () => {
  ...
  const loadMessages = async () => {
    setLoading(true);
    try {
      const filters: any = { type: 'platform' }; // Admin sees platform messages
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visualize e gerencie as mensagens de contato sobre a plataforma</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Lista de todas as mensagens recebidas sobre a plataforma
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{selectedMessage.type === 'platform' ? 'Dúvidas sobre a Plataforma' : 'Dúvidas sobre o Evento'}</p>
                </div>
                <div>
                  <Label className="flex items-center gap-2">

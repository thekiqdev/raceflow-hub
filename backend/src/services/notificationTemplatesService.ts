...
export const initializeDefaultTemplates = async (): Promise<void> => {
  ...
  const defaultTemplates: CreateNotificationTemplateData[] = [
    ...
    // Document templates
    {
      ...
      template_name: 'Documento Aprovado',
      template_type: 'email',
      target_audience: 'runner',
      subject: 'Documento Aprovado - Cronoteam',
      body_html: '<h1>Documento Aprovado!</h1><p>Olá {{userName}},</p><p>Seu documento <strong>{{documentType}}</strong> foi aprovado com sucesso.</p><p><strong>Arquivo:</strong> {{fileName}}</p>{{expiryDate}}<p>Você pode visualizar seus documentos no painel do runner.</p>',
      body_text: 'Documento Aprovado!\n\nOlá {{userName}},\n\nSeu documento {{documentType}} foi aprovado com sucesso.\n\nArquivo: {{fileName}}\n{{expiryDate}}Você pode visualizar seus documentos no painel do runner.',
      variables: {
        userName: 'Nome do usuário',
        documentType: 'Tipo do documento',
        fileName: 'Nome do arquivo',
        expiryDate: 'Data de validade (opcional, será vazio se não houver)',
      },
      is_active: true,
      is_system: true,
    },
    {
      ...
      template_name: 'Documento Rejeitado',
      template_type: 'email',
      target_audience: 'runner',
      subject: 'Documento Rejeitado - Cronoteam',
      body_html: '<h1>Documento Rejeitado</h1><p>Olá {{userName}},</p><p>Infelizmente seu documento <strong>{{documentType}}</strong> foi rejeitado.</p><p><strong>Arquivo:</strong> {{fileName}}</p><p><strong>Motivo da rejeição:</strong></p><p style="background-color: #fee; padding: 12px; border-left: 4px solid #f00; margin: 16px 0;">{{rejectionReason}}</p><p>Por favor, envie um novo documento corrigido através do painel do runner.</p>',
      body_text: 'Documento Rejeitado\n\nOlá {{userName}},\n\nInfelizmente seu documento {{documentType}} foi rejeitado.\n\nArquivo: {{fileName}}\n\nMotivo da rejeição:\n{{rejectionReason}}\n\nPor favor, envie um novo documento corrigido através do painel do runner.',
      variables: {
        userName: 'Nome do usuário',
        documentType: 'Tipo do documento',
        fileName: 'Nome do arquivo',
    ...
    {
      template_key: 'new_document_uploaded',
      template_name: 'Novo Documento Enviado (Admin)',
      template_type: 'email',
      target_audience: 'admin',
      subject: 'Novo Documento Enviado - {{runnerName}}',
      body_html: '<h1>Novo Documento Enviado</h1><p>Um novo documento foi enviado e está aguardando aprovação.</p><p><strong>Runner:</strong> {{runnerName}}</p><p><strong>CPF:</strong> {{runnerCpf}}</p><p><strong>Email:</strong> {{runnerEmail}}</p><p><strong>Tipo de Documento:</strong> {{documentType}}</p><p><strong>Arquivo:</strong> {{fileName}}</p><p>Por favor, acesse o painel administrativo para revisar o documento.</p>',
      body_text: 'Novo Documento Enviado\n\nUm novo documento foi enviado e está aguardando aprovação.\n\nRunner: {{runnerName}}\nCPF: {{runnerCpf}}\nEmail: {{runnerEmail}}\nTipo de Documento: {{documentType}}\nArquivo: {{fileName}}\n\nPor favor, acesse o painel administrativo para revisar o documento.',
      variables: {
        runnerName: 'Nome do runner',
        runnerCpf: 'CPF do runner',
        runnerEmail: 'Email do runner',
        documentType: 'Tipo do documento',
        fileName: 'Nome do arquivo',
      },
      is_active: true,
